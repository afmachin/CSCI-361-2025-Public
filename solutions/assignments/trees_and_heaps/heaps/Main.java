...
public class Main {
    public static void main(String[] args) {
         ...
         * 3
         *
         * We use our formula floor(size / 2) - 1to find the index of the first non-leaf node (starting
         * from the end of the heap). In this case, the index is 1.
         *
         * We then call heapifyDown on the index 1 node. This will have no impact on the heap as 5 is larger
         ...
         * 3
         *
         * We then call heapifyDown on the index 0 node. This will swap 9 and 2 resulting in [9, 5, 2, 3]
         *     9
         *    / \
         *   5   2
         *  /
         ...
         *
         * Iteration 1:
         * 9 is removed and the last node (3) is moved to the root resulting in [3, 5, 2]
         *     3
         *    / \
         *   5   2
