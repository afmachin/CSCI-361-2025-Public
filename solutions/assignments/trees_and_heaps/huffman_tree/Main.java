...
public class Main {
     ...
     * 00 decoded as: A
     * 01 decoded as: D
     * 1111100 decoded as: ZZZZZA
     * 10001 decoded as: ZAD
     * encode tests:
     * ZAD encoded as: 10001
     * ZZZZZA encoded as: 1111100
     *
     */
    public static void main(String[] args) throws Exception {
        Huffman huff = new Huffman();
        huff.buildTreeFromFile(args[0]);

        // Print the tree:
        huff.printTree(); // [16:] [ 6:] [ 1:A] [ 5:D] [10:Z]
